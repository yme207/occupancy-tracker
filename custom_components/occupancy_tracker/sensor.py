...
async def async_setup_entry(
    ...
    entities: list[SensorEntity] = [TotalOccupantCountSensor(entry.entry_id, runtime_data.engine)]
    entities.extend(
...
class TotalOccupantCountSensor(_EngineBoundSensor):
    """Whole-house occupant total (SPEC.md §8)."""

    _attr_state_class = SensorStateClass.MEASUREMENT
    _attr_icon = "mdi:account-multiple"

    def __init__(self, entry_id: str, engine: OccupancyEngine) -> None:
